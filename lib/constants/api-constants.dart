...
class AppConstants {
  ...
  static const String allbooksUri = '/api/v1/vendor/all-books';
  static const String currentbooksUri = '/api/v1/vendor/current-books';
  static const String completedbooksUri = '/api/v1/vendor/completed-books';
  static const String orderDetailsUri =
      '/api/v1/vendor/order-details?order_id=';
  static const String updatedbookstatusUri =
  ...
  static const String posOrderUri = '/api/v1/vendor/pos/books';
